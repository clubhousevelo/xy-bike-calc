class BikeCalculator {
    ...
    printBikeData() {
        ...
        title.innerHTML = `<h1 style="text-align: center; margin-bottom: 5px;">Bike Recommendations for ${clientName}</h1>
                          <p style="text-align: center; margin-bottom: ${clientNotes ? '5px' : '20px'};">Generated on ${new Date().toLocaleDateString()}${byLine}</p>
        ...
        targetSection.innerHTML = `
                <div style="margin-bottom: 12px; padding: 6px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
